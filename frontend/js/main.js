			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$viewLink('/reviews/one-more-link'),
						$author$project$Main$viewLink('/reviews/another-link'),
						$author$project$Main$viewLink('/reviews/another'),
						$author$project$Main$viewLink('/reviews/another-again')
					]))
			]),
