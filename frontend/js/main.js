...
var $author$project$Landing$Model = {};
var $author$project$Main$Model = F4(
	function (key, url, page, landing) {
		return {key: key, landing: landing, page: page, url: url};
	});
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A4($author$project$Main$Model, key, url, $author$project$Main$Landing, $author$project$Landing$Model),
...
var $author$project$Main$PathRequested = function (a) {
	return {$: 'PathRequested', a: a};
};
...
var $author$project$Main$headerButton = F2(
	function (txt, path) {
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$PathRequested(path))
				]),
			_List_fromArray(
				[
...
var $author$project$Main$LandingMsg = function (a) {
...
var $author$project$Landing$viewLink = F2(
	function (txt, path) {
		return A2(
			$elm$html$Html$a,
			_List_fromArray(
...
var $author$project$Landing$view = function (model) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$b,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Welcome to Wag the Pig!')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					A2($author$project$Landing$viewLink, 'Sign up', '/sign-up'),
					A2($author$project$Landing$viewLink, 'Log In', '/log-in')
				]))
		]);
};
var $author$project$Main$renderPage = function (model) {
	...
	return A2(
		...
		$elm$html$Html$map(
			function (lm) {
				return $author$project$Main$LandingMsg(lm);
			}),
		$author$project$Landing$view(model.landing));
};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$src('/assets/wagthepig-med.png')
								]),
							_List_Nil),
							A2($author$project$Main$headerButton, 'Profile', '/profile'),
							A2($author$project$Main$headerButton, 'Events', '/events'),
							A2($author$project$Main$headerButton, 'Sign out', '/sign-out')
						]))
				]),
